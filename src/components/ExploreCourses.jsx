...
const ExploreCourses = () => {
  ...
  const allCourses = [
    ...
    { title: "Mentorship Program 2025", category: "Mentorship", desc: "Get one-on-one guidance from expert mentors to clear all your doubts and stay on track with your preparation.", price: "Rs. 20,000 /-", img: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=1470&auto=format&fit=crop" },
    { title: "Mentorship Program 2026", category: "Mentorship", desc: "Long term mentorship for the next year's attempt.", price: "Rs. 30,000 /-", img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1470&auto=format&fit=crop" },
    ...
    { title: "Geography Optional Foundation", category: "Optional Foundation", desc: "Master Geography with our comprehensive foundation course.", price: "Rs. 35,000 /-", img: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?q=80&w=1470&auto=format&fit=crop" },
    { title: "Prelims Test Series 2025", category: "Test Series", desc: "Evaluate your preparation with our rigorous prelims test series.", price: "Rs. 8,000 /-", img: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=1470&auto=format&fit=crop" },
    { title: "Mains Test Series 2025", category: "Test Series", desc: "Enhance your answer writing skills with detailed evaluation.", price: "Rs. 12,000 /-", img: "https://images.unsplash.com/photo-1454165833767-0ef98925f44b?q=80&w=1470&auto=format&fit=crop" },
            ...
            <div key={idx} className="course-card-image">
              ...
              <div className="course-info-content">
                ...
                <div className="course-footer">
                  <p className="course-price-new">{course.price}</p>
                  <button className="btn-course-know">Know More</button>
                </div>
              </div>
            </div>
          )) : (
